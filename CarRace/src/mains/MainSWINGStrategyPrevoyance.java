...
public class MainSWINGStrategyPrevoyance {
	...
	public static void main(String[] args) {
		...
		Strategy strategy = new StrategyParametriquePrevoyance(radar, voiture, circuit, prevoyance);
		((StrategyParametriquePrevoyance)strategy).setParam(FileTools.loadParam(loadPlace+nomCircuit+loadMode));
